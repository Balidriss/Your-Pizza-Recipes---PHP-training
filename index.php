                        ...
                        <article class='<?php echo strtolower(preg_replace('/\s+/', '-', $recipe['title'])); ?>'>
                            ...
                            <?php if (isset($_SESSION['LOGGED_USER']) && $recipe['author'] === $_SESSION['LOGGED_USER']['email']) : ?>
                                <ul class="list-group list-group-horizontal">
                                    <li class="list-group-item"><a class="link-warning" href="recipes_update_confirm.php?id=<?php echo ($recipe['recipe_id']); ?>">Editer l'article</a></li>
                                    <li class="list-group-item"><a class="link-danger" href="recipes_delete_confirm.php?id=<?php echo ($recipe['recipe_id']); ?>">Supprimer l'article</a></li>
                                </ul>
                            <?php endif; ?>
                        </article>
